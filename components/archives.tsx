...
const Archives = () => {
  return (
    <section className="bg-black min-h-screen md:py-50 px-4 sm:p-6 md:p-10 flex flex-col justify-center items-center">
      ...
      <main className="w-full mt-6 sm:mt-8 md:mt-10 flex flex-col gap-6 sm:gap-8 md:gap-10 justify-start items-start">
            ...
            <div className="text-white flex flex-col justify-between px-4 sm:px-0">
              <div>
                <h1 className="text-xl sm:text-2xl md:text-[28px]">
                  &quot;The Fight for Justice: Ken Saro-Wiwa and the Ogoni
                  Struggle&quot;
                </h1>
                <p className="text-sm sm:text-base">
                  In the 1990s, the world watched as environmental activist and
                  writer Ken Saro-Wiwa led a non-violent campaign against Shell
                  and the Nigerian government’s exploitation of Ogoni land. His
                  arrest and execution in 1995 sparked global outrage and
                  forever changed the conversation around oil, justice, and
            ...
            <div className="text-white flex flex-col justify-between px-4 sm:px-0">
              <div>
                ...
                <p className="text-sm sm:text-base">
                  ...
                  assert their rights to self-determination and resource
                  control. The Kaiama Declaration became a cornerstone of Niger
                  Delta resistance, reshaping activism across the region.
                </p>
              </div>
              <div className="flex flex-row items-center gap-2 mt-4 sm:mt-0">
                <p className="text-sm sm:text-base">Read more</p>
